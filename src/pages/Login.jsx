...
function Login() {
  ...
  const googleAuthHandler = (credentialResponse) => {
    const credential = jwtDecode(credentialResponse.credential);
    const updatedFormData = {
      email: credential.email,
      accountType: formData.accountType, // Preserve account type
      password: credential.email.split("@")[0], // Generate password
    };
    ...
    if (formData.accountType === "User") {
      ...
      axios
        .post(apiUrl, { ...updatedFormData, accountType: "User", logintype: "Google" })
        .then((response) => {
        ...
        >
          ...
          <GoogleLogin
            ...
            onSuccess={(credentialResponse) => {
              googleAuthHandler(credentialResponse);
            }}
            onError={() => {
