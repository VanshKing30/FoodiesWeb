        ...
        <div className="mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center md:space-x-8 bg-gray-900 py-[10%]">
            <div className="md:w-1/2 order-2 md:order-1 md:px-20 px-10 text-center md:text-start">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-500 mb-4">
                Welcome to Foodies
              </h2>
            ...
            <div className="md:w-1/2 order-1 md:order-2 md:px-8 flex justify-center">
              <img
                ...
                alt="Food"
                className="rounded-lg shadow-lg mb-8 h-56 sm:h-48 w-[80%] sm:w-[100%] md:h-96 md:w-[80%]"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:space-x-8 bg-gradient-to-t from-blue-950 via-blue-950 to-gray-900 py-[10%]">
            <div className="md:w-1/2 order-1 md:order-1 md:px-20 mt-[5rem] flex justify-center">
              <img
                ...
                alt="Food"
                className="rounded-lg shadow-lg mb-8 h-56 w-[100%] md:h-96 md:w-[100%]"
              />
            </div>
          ...
          <div className="w-full flex flex-col justify-center py-[7rem] bg-gray-900">
            <h2 className="text-3xl font-bold text-green-500 mb-2 md:mb-4 text-center">
              {" "}
              Our Mission{" "}
            </h2>
            <div className="w-full flex flex-row sm:flex-col md:flex-row justify-center py-[5rem] text-center">
              <div className="w-[95%] lg:w-[25%] bg-gray-950 p-[2rem] hover:translate-y-2 items-center md:mx-[1rem] mx-auto rounded-xl shadow-2xl shadow-slate-800 mb-[5rem] md:mb-0">
                <img
                  ...
                  alt="Food"
                  className="rounded-lg shadow-lg mb-8 p-[1rem]"
                />
                <span className="p-[1rem]">
                  We simplify campus dining, ensuring effortless ordering from
                  college canteens. Our user-friendly platform lets you browse
                  menus, place orders, and track deliveries seamlessly. Enjoy
                  more time to focus on what matters during busy college days
                  with our efficient service.
                </span>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:space-x-8 bg-gradient-to-t from-blue-950 via-blue-950 to-gray-900 py-[12%]">
            <div className="md:w-1/2 order-1 md:order-1 md:px-20">
              <img
                ...
                alt="Food"
                className="rounded-lg shadow-lg mb-8 h-56 w-[100%] md:h-96"
              />
            </div>
