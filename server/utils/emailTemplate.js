...
function tokenExpired(username) {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
      <div class="container">
        ...
        <div style="text-align: center; margin-top: 20px;">
          <p>You can still request another token by clicking resend verification email on the main website:</p>
          <a href="${process.env.FRONTEND_URL}" style="color: white" class="btn-home">Go to Home Page</a>
        </div>
      </div>
    </body>
...
module.exports = { gmailContent, successFullVerification, tokenExpired };